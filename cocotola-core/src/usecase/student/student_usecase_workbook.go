...
func (u *StudentUsecaseWorkbook) RetrieveWorkbookByID(ctx context.Context, organizationID *rsuserdomain.OrganizationID, operatorID *rsuserdomain.AppUserID, workbookID int) (*workbookretrievedomain.WorkbookModel, error) {
	return &workbookretrievedomain.WorkbookModel{
		ID:   1,
		Name: "test",
		Problems: []*workbookretrievedomain.ProblemModel{
			{
				Type: "text",
