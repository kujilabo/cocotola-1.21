...
import (
	...
	srcdomain "github.com/kujilabo/cocotola-1.21/cocotola-synthesizer/src/domain"
)
...
func (_m *SynthesizerUsecase) Synthesize(ctx context.Context, lang5 *domain.Lang5, void string, text string) (*srcdomain.AudioModel, error) {
	...
	var r0 *srcdomain.AudioModel
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *domain.Lang5, string, string) (*srcdomain.AudioModel, error)); ok {
		return rf(ctx, lang5, void, text)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *domain.Lang5, string, string) *srcdomain.AudioModel); ok {
		r0 = rf(ctx, lang5, void, text)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*srcdomain.AudioModel)
		}
	}
...
func (_c *SynthesizerUsecase_Synthesize_Call) Return(_a0 *srcdomain.AudioModel, _a1 error) *SynthesizerUsecase_Synthesize_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SynthesizerUsecase_Synthesize_Call) RunAndReturn(run func(context.Context, *domain.Lang5, string, string) (*srcdomain.AudioModel, error)) *SynthesizerUsecase_Synthesize_Call {
	_c.Call.Return(run)
	return _c
}
